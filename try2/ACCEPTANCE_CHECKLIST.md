...
| Native editability | component/feature/joint/rebuild/native-save audit | PASS: F3D/STEP/STL, component/features/joints, and `design.computeAll()` smoke all pass |
...
| Final report answers all applicable items with amendment caveat | audited report | PASS |
