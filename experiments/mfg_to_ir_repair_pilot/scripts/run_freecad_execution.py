...
SCRIPT_DIR = ROOT / "experiments" / "mfg_to_ir_repair_pilot" / "scripts"
sys.path.insert(0, str(ROOT))
sys.path.insert(0, str(SCRIPT_DIR))

from common import RESULTS, RUNS, VERSIONS, dump_json, ensure_dirs, frozen_rows, write_csv  # type: ignore  # noqa: E402
...
def run_one(version: str, row: dict[str, str]) -> dict[str, Any]:
    ...
    if not ir_path.exists():
        return {
            ...
            "failure_reason": "executable_cad_ir_v1_2.json missing",
        }
