...
try:
 ...
 (out/'assembly_result.json').write_text(json.dumps({'status':'SUCCESS','condition':result_condition,'source_condition':source_condition,'placement_authority':'sanitized URDF canonical transforms','visual_adjustments':0,'links':len(objects)},indent=2)+'\n')
