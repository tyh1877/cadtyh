...
if __name__=="__main__":
    parser=argparse.ArgumentParser(); parser.add_argument("--full-repair",action="store_true"); parser.add_argument("--knowledge-ablation",action="store_true"); parser.add_argument("--governance-dry-run",metavar="CONFIG"); parser.add_argument("--mechanical-ablation-development",metavar="CONFIG"); parser.add_argument("--geometry-protection-dry-run",metavar="CONFIG"); parser.add_argument("--result-dir"); parser.add_argument("--artifact-dir"); args=parser.parse_args()
    raise SystemExit(run_geometry_protection_dry_run(args.geometry_protection_dry_run) if args.geometry_protection_dry_run else (run_mechanical_ablation_development(args.mechanical_ablation_development,args.result_dir,args.artifact_dir) if args.mechanical_ablation_development else (governance_dry_run(args.governance_dry_run) if args.governance_dry_run else (run_knowledge_ablation() if args.knowledge_ablation else (run_full_repair() if args.full_repair else main())))))
