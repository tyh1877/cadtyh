...
def validate(config_path, result_dir):
    ...
    checks = {
        ...
        "no_overall_score": deltas["no_overall_score"] is True and "overall_score" not in json.dumps(deltas),
